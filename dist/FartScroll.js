...
const FartScroll = ({
  ...
  useEffect(() => {
    if (scrollFart) {
      window.addEventListener('scroll', playScrollFart, false);
    }

    if (resizeFart) {
      window.addEventListener('resize', playResizeFart, false);
    }
